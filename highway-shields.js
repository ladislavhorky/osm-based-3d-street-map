cityLabels = {
  "layers": {
    ...
    "motorway-numbers": {
      "filter": ["all",["==","#group","transportation_name"],["in","$class","motorway"],["<","$ref_length",10]],
      "label": true,
      "label-source": "$ref",
      "label-origin": "center-center",
      "label-no-overlap": true,
      "label-size": 15,
      "label-color": [255,235,160,255],
      "line-points": ["by-length",50000,25000],
      "zbuffer-offset": [-20,-50,-50],
      "z-index": 10
    }
  }
